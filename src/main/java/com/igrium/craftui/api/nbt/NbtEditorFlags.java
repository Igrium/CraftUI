...
public final class NbtEditorFlags {
    ...
    public static final int RETURN_MODIFIED = 128;
    public static final int RETURN_MODIFIED_LABEL = 256;
    public static final int RETURN_LEFT_CLICKED = 512;
    public static final int RETURN_RIGHT_CLICKED = 1024;
    public static final int RETURN_ADDED_ITEM = 2048;
    public static final int RETURN_REMOVED_ITEM = 4096;
    public static final int RETURN_REARRANGED = 8192;
